<?php
    ...
    $schedulesResult = $c_patient->getPatientAppointments($database, [
        'userid' => $user['pid'], 
        'scheduledate' => [
            'condition' => '>=',
            'value' => $today
    ...
    if ($schedulesResult['success']) {
        $schedules = $schedulesResult['data']->fetch_all(MYSQLI_ASSOC);
    }
?>
<tr>
    <td colspan="4" >
